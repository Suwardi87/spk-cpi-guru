  ...
  <nav class="navbar navbar-expand-lg px-3" style="background-color:#00695c;color:white;">
    <div class="container-fluid">
      ...
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item"><a class="nav-link text-white" href="nilai.php" <?= $_SESSION['role'] !== 'admin' ? 'style="display: none; opacity: 0.5;"' : '' ?>>Kelola Nilai</a></li>
        <li class="nav-item"><a class="nav-link text-white" href="hasil.php">Hasil CPI</a></li>
        <li class="nav-item">
          <a class="nav-link text-white" href="cetak_laporan.php"
            <?= ($_SESSION['role'] !== 'admin' && $_SESSION['role'] !== 'kepala_sekolah') ? 'style="display: none; opacity: 0.5;"' : '' ?>>
            Cetak Hasil
          </a>
        </li>
